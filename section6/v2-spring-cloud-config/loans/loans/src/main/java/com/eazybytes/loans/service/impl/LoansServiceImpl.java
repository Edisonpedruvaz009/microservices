...
import com.eazybytes.loans.exception.LoanAlredyExistsException;
...
public class LoansServiceImpl implements ILoansService {
    ...
    public void createLoan(String mobileNumber) {
        ...
        if(optionalLoans.isPresent()){
            throw new LoanAlredyExistsException("Loan already registered with given mobileNumber "+mobileNumber);
        }
